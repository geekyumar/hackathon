...
<html lang="en">
  <head>
    ...
    <title>Rules and Regulations - Hackathon 2023</title>
    <link
      rel="shortcut icon"
              ...
              <div class="w-full px-4 lg:w-8/12">
                <div>
                  <h2
                    ...
                    "
                  >
                   Rules and Regulations for Hackathon 2023
                  </h2>
                  <p
                  ...
                  <p
                    class="wow fadeInUp mb-10 text-base leading-relaxed text-[#e4e4e4]"
                    data-wow-delay=".1s"
                  >
                    There's a time and place for everything… including asking
                    for reviews. For instance: you should not asking for a
                  ...
                  >
                    <div class="mx-auto max-w-[530px]">
                      ...
                      <span class="text-sm italic text-[#e4e4e4]">
                        “Andrio Domeco”
                      </span>
                    </div>
                    <div>
                  ...
                  <p
                    class="wow fadeInUp mb-11 text-base leading-relaxed text-[#e4e4e4]"
                    data-wow-delay=".1s"
                  >
                    At quo cetero fastidii. Usu ex ornatus corpora sententiae,
                    vocibus deleniti ut nec. Ut enim eripuit eligendi est, in
                  ...
                  <div class="-mx-4 mb-12 flex flex-wrap items-center">
                    ...
                    <div class="w-full px-4 md:w-1/2">
                      <div
                        ...
                        data-wow-delay=".1s"
                      >
                        <span class="mr-5 text-sm font-medium text-[#e4e4e4]">
                          Share This Post
                        </span>
